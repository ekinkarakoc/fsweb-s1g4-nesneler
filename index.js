...
function MenuElemaniOlustur(gelenIsim, gelenFiyat, gelenKategori) {
  let menuElemanları = {};
  menuElemanları.isim = gelenIsim;
  menuElemanları["fiyat"] = gelenFiyat;
  menuElemanları.kategori = gelenKategori;
  return menuElemanları;
}
console.log(MenuElemaniOlustur("cay", 4, "icecekler"));
...
*/
MenuElemaniOlustur("Karışık piz");
...
DegerlendirmeEkle(degerlendirmeler, "Mehmet", 1, "Berbat!");
/*  Görev 6: 
...
function AnahtardanDegerlendirmeAl(dizi, i) {
  return (
    dizi[i].isim +
    " isimli kişi " +
    dizi[i].puan +
